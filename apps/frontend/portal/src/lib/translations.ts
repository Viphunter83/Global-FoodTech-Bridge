...
export type TranslationKey =
    ...
    | 'compliance_optional_docs'
    | 'compliance_upload_type'
    | 'compliance_empty_templates'
    | 'btn_retry'
    | 'loading'
...
export const translations: Record<Language, Record<TranslationKey, string>> = {
    en: {
        ...
        alert_dispatched: 'Product dispatched to logistics partner',
        bc_waiting_logistics: 'Waiting for Logistics Confirmation',
        compliance_required_docs: 'Required Documents (per Template)',
        compliance_optional_docs: 'Additional Documents',
        compliance_upload_type: 'Document Type',
        compliance_empty_templates: 'No templates found. Please initialize the system.',
        btn_retry: 'Retry',
        loading: 'Loading',
        ...
        msg_batch_created: 'Batch Passport Created Successfully!',
    ...
    ru: {
        ...
        alert_dispatched: 'Товар передан логистическому партнеру',
        bc_waiting_logistics: 'Ожидание подтверждения от логистики',
        compliance_required_docs: 'Необходимые документы (согласно шаблону)',
        compliance_optional_docs: 'Дополнительные документы',
        compliance_upload_type: 'Тип документа',
        compliance_empty_templates: 'Шаблоны не найдены. Пожалуйста, инициализируйте систему.',
        btn_retry: 'Повторить',
        loading: 'Загрузка',
        ...
        msg_batch_created: 'Паспорт партии успешно создан!',
    ...
    ar: {
        ...
        alert_dispatched: 'تم إرسال المنتج إلى شريك اللوجستيات',
        bc_waiting_logistics: 'في انتظار تأكيد اللوجستيات',
        compliance_required_docs: 'المستندات المطلوبة (حسب القالب)',
        compliance_optional_docs: 'مستندات إضافية',
        compliance_upload_type: 'نوع المستند',
        compliance_empty_templates: 'لم يتم العثور على قوالب. يرجى تهيئة النظام.',
        btn_retry: 'إعادة المحاولة',
        loading: 'جاري التحميل',
        form_select_template: 'حدد قالب سلسلة التوريد',
        ...
        msg_batch_created: 'تم إنشاء جواز سفر الدفعة بنجاح!',
    ...
    vi: {
        ...
        alert_dispatched: 'Sản phẩm đã được chuyển đến đối tác vận tải',
        bc_waiting_logistics: 'Đang chờ xác nhận từ phía vận tải',
        compliance_required_docs: 'Tài liệu bắt buộc (theo mẫu)',
        compliance_optional_docs: 'Tài liệu bổ sung',
        compliance_upload_type: 'Loại tài liệu',
        compliance_empty_templates: 'Không tìm thấy mẫu. Vui lòng khởi tạo hệ thống.',
        btn_retry: 'Thử lại',
        loading: 'Đang tải',
        ...
        msg_batch_created: 'Đã tạo Hộ chiếu lô hàng thành công!',
        btn_upload_file: 'Tải lên tệp',
